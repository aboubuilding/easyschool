			...
			<div class="main-header">
				...
				<div class="header-left active">
					<a href="{{ url('/') }}" class="logo logo-normal">
						<img src="{{asset('app')}}/assets/img/logo_easy.png" alt="Img">
					</a>
				...
				<ul class="nav user-menu">
					...
					<li class="nav-item dropdown has-arrow main-drop profile-nav">
						...
						<div class="dropdown-menu menu-drop-user">
							...
							<a class="dropdown-item" href="sales-report.html"><i class="ti ti-file-text me-2"></i>Mes notifications</a>
							<a class="dropdown-item" href="general-settings.html"><i class="ti ti-settings-2 me-2"></i>Changer de mot de passe</a>
							<hr class="my-2">
				...
				<div class="dropdown mobile-user-menu">
					...
					<div class="dropdown-menu dropdown-menu-right">
						...
						<a class="dropdown-item" href="general-settings.html">Mes notifications </a>
						<a class="dropdown-item" href="signin.html">Changer de mot de passe  </a>
